...
Note that the 'Manifold' variance is error due to the manifold structure of the response, and the location of the residuals in the tangent space of the manifold (rather than on the manifold itself). Thus it could be considered as part of Explained Variance, and is included in the R squared calculation: $R^2 = (SSR+SSM)/SST = 1-SSE/SST =$ `r calc_Rsqr_spd(Y = simData$Y, Yhat = mod1$Yhat)`.
